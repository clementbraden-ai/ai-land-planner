...
export const RobotIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M10 20.25H14" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75a7.5 7.5 0 1 1 15 0v2.25a.75.75 0 0 1-.75.75H5.25a.75.75 0 0 1-.75-.75V12.75Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 9.75h.008v.008H8.25V9.75Zm7.5 0h.008v.008H15.75V9.75Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 2.25 9.75 4.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 2.25 14.25 4.5" />
    </svg>
);
...
export const LineIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21 20.25 3.75" />
    </svg>
);
...
export const LightBulbIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.311a7.5 7.5 0 0 1-7.5 0c-1.42 0-2.798.347-4.006 1.007a.75.75 0 0 1-1.054-.628A18.38 18.38 0 0 1 6 6.311a7.5 7.5 0 0 1 12 0c.636 4.372-1.356 8.56-4.5 11.246Z" />
    </svg>
);
